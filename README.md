...
A lightweight, robust REST API for managing To-Do tasks, built with Java, Spring Boot, Spring Data JPA, and PostgreSQL.

---

## 🛠️ Technology Stack
* **Language:** Java 17
* **Framework:** Spring Boot (v4.0.6 Parent)
...
* [Maven](https://maven.apache.org/) (optional, as the Maven Wrapper `./mvnw` is included in the project)
...
* **[TaskController.java](src/main/java/com/example/todo/controller/TaskController.java):** Receives HTTP requests, maps request paths, handles payloads, and delegates processing to the service layer.
* **[TaskService.java](src/main/java/com/example/todo/services/TaskService.java):** Contains business logic rules and bridges the Controller to the Repository.
* **[TaskRepository.java](src/main/java/com/example/todo/repository/TaskRepository.java):** Extends `JpaRepository` to perform JDBC commands (SELECT, INSERT, UPDATE, DELETE) against the PostgreSQL instance.
* **[Task.java](src/main/java/com/example/todo/model/Task.java):** Map annotations map Java classes directly to PostgreSQL relational tables.
